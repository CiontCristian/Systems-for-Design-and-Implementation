...
public class Sort<T> implements Comparator<T> {
    ...
    //private List<Sort<T>> list=new ArrayList<>();
    private Sort<T> next=null;
    ...
    public int compare(T o1, T o2) {
        ...
        return this.comp1(o1,o2,0);
    }
    public Sort<T> and(Sort<T> sort){
            this.next=sort;
            return this;
    }
    public int comp1(T o1,T o2, int x){
        try {
            ...
            else if ( comp1.equals(comp2) && x+1==this.sortField.length ) return this.next.comp1(o1,o2,0);
