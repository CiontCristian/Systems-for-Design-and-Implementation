...
public class Console {
    ...
    private void deleteBook() throws IOException{
        ...
        book.getPurchased().forEach(purchased -> purchasedService.delete(purchased.getId()));
    ...
    private void deleteClient() throws IOException {
        ...
        client.getPurchased().forEach(purchased -> purchasedService.delete(purchased.getId()));
    ...
    private void buyBook(){
        ...
        try{
            Book book=bookService.getOne(purchased.getBookID());
            Client client=clientService.getOne(purchased.getClientID());

            book.getPurchased().add(purchased);
            client.getPurchased().add(purchased);
